...
NOZZLE_TEMP   = 220         # °C
BED_TEMP      = 60          # °C
BED_CX        = 210.0       # bed center X mm  (420mm bed)
BED_CY        = 210.0       # bed center Y mm  (420mm bed)
...
z_base_s  = RING_HEIGHT + Z_AMP
z_range   = N_MESH_REVS * LAYER_HEIGHT
z_base_end = z_base_s + z_range
t_tpre_s  = t1_e
...
print(f'  Printer     : Elegoo Neptune 4 Max')
